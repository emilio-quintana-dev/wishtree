...
const FeaturesBlocks = () => {
  return (
    <section className="relative">
      ...
      <div
        className="absolute inset-0 top-60 md:mt-24 lg:mt-0 bg-gray-100 pt-60 pointer-events-none"
        aria-hidden="true"
      ></div>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                Protect your personal information and receive your deliveries
                securely by keeping your legal name and address confidential.
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                You have the option to select items from any online store or
                generate customized cash funds for purposes such as college
                expenses, travel expenses, and much more.
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                Wishtree will assist users regardless of what kind of content
                they create.
              </p>
            </div>
          </div>
